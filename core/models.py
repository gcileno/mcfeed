...
class Vendedor (models.Model):
    ...
    metas = models.ForeignKey('Metas',on_delete=models.SET_NULL,null=True, related_name='vendedor')
    filial=models.ForeignKey('Filial',on_delete=models.SET_NULL,null=True, related_name='vendedor')
